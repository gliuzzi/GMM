...
class Newton:
        ...
        def __init__(self,n,f0,f_1,g_1,x,x_1,eps,maxiter,iprint,funct,d1,dnr1,d2,n_iter_glob,var):
            self.n = n
            self.f0=f0
            self.f_1=f_1
            self.g_1 = g_1
        ...
        def gradiente_Hessiano_B(self, n ,f, f_1, g_1, funct, d1,d1_norm, d2, alpha, beta,n_iter_glob):
        ...
        def gradiente_Hessiano_M(self, n ,f, f_1, funct, d1,d1_norm,d2, alpha, beta,n_iter_glob):
        ...
        def gradiente_Hessiano(self,n,x,f,prec,funct,d1,d1_norm,d2,n_iter,n_iter_glob):
        #def gradiente_Hessiano(self,n,x,f,prec,funct,d1,d1_norm,d2,n_iter,n_iter_glob):
            #d1_norm=np.linalg.norm(d1,2)
            d2_norm=np.linalg.norm(d2,2)
...
#            f=funct(x)
            ...
            while True:
                ...
                if (var == 0):
                   g,H=self.gradiente_Hessiano(n,x,f,prec,funct,d1,dnr1,d2,n_iter,n_iter_glob)
                   
                if (var == 1):  
                   g,H=self.gradiente_Hessiano_M( n, f, f_1, funct, d1,dnr1,d2, x_1[0], x_1[1],n_iter_glob)
                
                if (var == 2):
                   g,H=self.gradiente_Hessiano_B( n, f, f_1,g_1,funct, d1,dnr1,d2, x_1[0], x_1[1],n_iter_glob)
