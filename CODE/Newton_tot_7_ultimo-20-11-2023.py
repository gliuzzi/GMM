...
class Newton:
        ...
        def gradiente_Hessiano_D(self, n ,f, f_1,x, x_1, g_1, funct, d1,d2, alpha, beta,n_iter_glob,var):
...
#            f=funct(x)
            ...
            while True:
                ...
                if (var >= 3):
                   g,H=self.gradiente_Hessiano_D( n, f, f_1, x, x_1, g_1, funct, d1,d2, x_1[0], x_1[1],n_iter_glob,var)
